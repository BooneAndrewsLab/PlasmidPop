...
and run in frame to the first stop codon (`TAA`, `TAG`, `TGA`), on both
strands, including frames that cross the origin of a circular sequence. The
list updates in the background whenever the sequence changes.
